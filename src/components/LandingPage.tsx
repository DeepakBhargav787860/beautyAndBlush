          ...
          <Carousel.Slide key={idx}>
            ...
            >
              ...
              >
                ...
                >
                  <Title order={1} size="60px" mb="md" sx={{ fontFamily: 'Cormorant Garamond, serif' }}>
                    {slide.title}
                  </Title>
                  <Text size="lg" mb="xl">
                    {slide.subtitle}
...
>
      ...
      <Grid.Col md={6} sm={12} >
        <Box p={40}>
          ...
          <Text size="lg" color="dimmed" mb="lg">
            ...
            or fill out our online booking & enquiry form and we will contact
            you.
          </Text>
          <Button
            size="md"
  ...
  sm={12}
  sx={{
    backgroundImage: `url(${new URL('../assets/images/slider4.avif', import.meta.url).href})`,
    backgroundSize: 'cover',
    backgroundPosition: 'center',
    minHeight: rem(300),
  }}
    ...
    <Grid gutter="sm">
      {galleryImages.map((img, idx) => (
        <Grid.Col key={idx} xs={12} sm={6} md={4}>
          <motion.div initial={{ scale: 0.9, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} transition={{ duration: 0.6, delay: idx * 0.1 }}>
            <Box
              sx={{
                position: 'relative',
                overflow: 'hidden',
            ...
            >
              <Image src={img} alt={`Gallery ${idx + 1}`} sx={{ width: '100%', height: rem(250), objectFit: 'cover', transition: 'transform 0.5s ease' }} />
            </Box>
          </motion.div>
        </Grid.Col>
      ))}
  ...
  <Container size="lg">
    <Grid gutter={50}>
      ...
      <Grid.Col xs={12} md={4}>
        ...
        >
          <Image src="/logo.png" alt="SpaMagic Logo" width={140} mb="md" />
          <Text color="dimmed" size="sm" maw={280} lh={1.7}>
            SpaMagic is your haven for ultimate relaxation. Indulge in our luxurious spa treatments
      ...
      <Grid.Col xs={6} md={4}>
        ...
        <List spacing="sm" size="sm" center>
          {['Home', 'Services', 'About Us', 'Contact', 'Book Now'].map((link) => (
            <List.Item
              key={link}
             // component="a"
              //href="#"
      ...
      <Grid.Col xs={6} md={4}>
        ...
        <Text size="sm" mb={4}>123 Wellness Street, Beauty City</Text>
        <Text size="sm" mb={4}>
          Phone:{' '}
          <a href="tel:+1234567890" style={{ color: '#333', fontWeight: 500 }}>
            +1 (234) 567-890
          </a>
        </Text>
        <Text size="sm" mb={8}>
          Email:{' '}
          <a href="mailto:info@spamagic.com" style={{ color: '#333', fontWeight: 500 }}>
            info@spamagic.com
          </a>
        </Text>
        ...
        <Group spacing="sm" mt="md">
          {[IconBrandFacebook, IconBrandInstagram, IconBrandTwitter].map((Icon, idx) => (
            <ActionIcon
              key={idx}
              component="a"
              href="#"
